...
const Corner = () => (
  <CornerStyles>
    <a
      href="https://github.com/DsTansice/dev-cover"
      target="_blank"
    ...
    >
      <svg width="80" height="80" viewBox="0 0 250 250" aria-hidden="true">
        ...
        />
        <path
          d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 
          127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 
